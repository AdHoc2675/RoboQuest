...
ARoboQuestCharacter::ARoboQuestCharacter()
{
...
void ARoboQuestCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{	
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent))
	{
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ARoboQuestCharacter::Move);
...
void ARoboQuestCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ARoboQuestCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
